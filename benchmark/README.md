...
build artifacts, and M1/H1/H2/H3/H5/H8 may only modify the fixture, write the specified
...
2. **Where the agent writes** (also stated in the prompts):
   ...
   - Hands-on tasks (M1/H1/H2/H3/H5/H8): the agent edits files under `/app/fixture/`
